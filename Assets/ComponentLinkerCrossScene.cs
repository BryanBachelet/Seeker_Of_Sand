...
public class ComponentLinkerCrossScene : MonoBehaviour
{
    ...
    private GameObject m_PlayerObjectRef; //Object r�f�rence
    ...
    private GameObject m_MainCamera; //Object r�f�rence
    ...
    private GameObject m_UpgradeScreenReference; //Object r�f�rence
    ...
    private GameObject m_PillarObject; //Object r�f�rence
    ...
    private GameObject m_enemyManagerObjectRef; //Object r�f�rence
    ...
    private GameObject m_dayCycleControllerObjectReference; //Object r�f�rence
