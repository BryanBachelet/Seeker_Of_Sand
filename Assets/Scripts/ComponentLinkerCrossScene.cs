...
public class ComponentLinkerCrossScene : MonoBehaviour
{
    ...
    #region inputSpellBookOpen
    private InputSpellBookOpen m_InputSpellBookOpen;
    [SerializeField] private ClicOnBook m_clicOnBook;
    #endregion
    ...
    public void ComponentInitialization()
    {
        ...
        m_InputSpellBookOpen = m_enemyManager.GetComponent<InputSpellBookOpen>();
