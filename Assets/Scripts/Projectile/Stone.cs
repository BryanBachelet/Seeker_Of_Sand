...
public class Stone : Projectile
{
    ...
    public override void CollisionEvent(Collider other)
    {
        ...
        enemyTouch.ReceiveDamage(spellProfil.name, damageStatData, (other.transform.position - transform.position).normalized, m_power, (int)m_characterShoot.lastElement, (int)m_characterProfil.stats.baseStat.damage);
    }
