...
class TIPS_2Editor : CustomPassDrawer
{
    private class Styles
    {
        ...
        public static GUIContent position = new GUIContent("Position", "Position reference to center.");
    ...
    {
        position = customPass.FindPropertyRelative("position");
    ...
    {
        position.objectReferenceValue = EditorGUI.ObjectField(rect, Styles.position, position.objectReferenceValue, typeof(Transform), false);
...
class TIPS_2 : CustomPass
{
    ...
    protected override void Execute(CustomPassContext ctx)
    {
        ...
        if (mesh != null && tipsMeshMaterial != null && EnemyManager.currentAltarBehavior != null)
        {
            ...
            Matrix4x4 trs = Matrix4x4.TRS(EnemyManager.currentAltarBehavior.transform.position + new Vector3(0,-13,0), Quaternion.Euler(0f, Time.realtimeSinceStartup * rotationSpeed, 0f/*Time.realtimeSinceStartup * rotationSpeed * 0.5f*/), Vector3.one * size);
