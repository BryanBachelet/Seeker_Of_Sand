   ...
   return 0;
    ...
    void SurfaceFunction(inout Surface o, inout ShaderData d)
    {
        ...
        float3 worldNormalVertex = d.worldSpaceNormal;
            ...
            d.tangentSpaceViewDir = mul(d.worldSpaceViewDir, float3x3(d.worldSpaceTangent, cross(d.worldSpaceTangent, d.worldSpaceNormal), d.worldSpaceNormal));
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat/Example_Snow_Base894934850"
   Fallback "Hidden/MicroSplat/Example_Snow_Base894934850"
