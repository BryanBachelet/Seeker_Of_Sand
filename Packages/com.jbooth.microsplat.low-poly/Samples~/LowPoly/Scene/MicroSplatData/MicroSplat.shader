...
Shader "MicroSplat/Terrain"
{
   Properties
   {
      ...
      _ToonTerrainSize("Toon Terrain Size", Vector) = (512,512,0,0)

         _ToonEdgeHardness("ToonEdgeHardness", Range(0.01, 3)) = 0.5
         
      _ToonWireSaturationBrightness("Wire Params", Vector) = (1,1,0,0)
      _ToonWireSmoothing("Wire Smooth", Range(0.01, 10)) = 1
      _ToonWireThickness("Wire Thickness", Range(0.01, 10)) = 1
   ...
   #pragma fragment Frag
      ...
      #define _TOONHARDEDGENORMAL 1
      #define _TOONWIREFRAME 1
      #define _TOONWIREWORLDSPACE 1
      #define _WIRESATURATIONBRIGHTNESS 1
      #define _TOONFLATTEXTURE 1
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat/Terrain_Base2045589883"
   Fallback "Hidden/MicroSplat/Terrain_Base2045589883"
