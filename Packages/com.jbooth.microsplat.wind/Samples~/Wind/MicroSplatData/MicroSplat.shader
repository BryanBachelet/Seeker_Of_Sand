...
#   define UNITY_LOOP
      ...
      half2 _WindEmissive;
         ...
         half _GlitterGraininess;
         half _GlitterShininess;
         half _GlitterViewDep;
         half _GlitterThreshold;
         float2 _GlitterUVScale;
         half _GlitterStrength;
         float4 _GlitterDistFade;
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat/Terrain_Base864301408"
   Fallback "Hidden/MicroSplat/Terrain_Base864301408"
