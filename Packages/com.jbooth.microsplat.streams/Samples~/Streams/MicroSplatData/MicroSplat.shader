...
Shader "MicroSplat/Example_Streams"
{
   Properties
   {
      ...
      _TraxFXThresholds("Trax FX Thresholds", Vector) = (0,0,0,0)
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat/Example_Streams_Base-774523134"
   Fallback "Hidden/MicroSplat/Example_Streams_Base-774523134"
