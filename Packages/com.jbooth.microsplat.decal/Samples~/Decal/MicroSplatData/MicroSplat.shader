...
Shader "MicroSplat/Terrain"
{
   ...
   #pragma fragment Frag
      ...
      #define _DECAL 1
      #define _DECAL_MAX4 1
      #define _DECAL_STATICMAX512 1
      #define _DECAL_SPLAT 1
...
void PrepareStochasticUVs(float scale, float2 uv, out float2 uv1, out float2 uv2, out float2 uv3, out half3 weights)
{
   ...
   weights = half3(w1, w2, w3);
      ...
      void CullDrawStaticDecal(int i, float3 worldPos, float3 localPos, inout DecalOutput o, float2 dx, float dy)
      {
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/MicroSplat/Terrain_Base1776133942"
   Fallback "Hidden/MicroSplat/Terrain_Base1776133942"
